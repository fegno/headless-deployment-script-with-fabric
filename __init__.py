def users_mannual():
    ...
    input parameters: 
    fab deploy \ 
    	--migrate  		@> to do migration in the master; default=True
    	--dependencies	@> to install dependencies in every server; default=True	; works only for --django or --deploy_together 
